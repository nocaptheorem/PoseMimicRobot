...
namespace NoCAPTheorem.Virtual
{
  ...
  [Export] public AnimationPlayer ShadowAnimPlayer = null!;
  ...
  #region 8. Shadow Pathing
  [ExportGroup("8. Shadow Pathing")]
  [Export] public float ShadowWalkSpeed = 1.8f; // Tune to match the animation's stride length
  [Export] public float ShadowTurnSpeed = 0.1f; // Radians per second
  #endregion
